...
const ProductDetail: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await fetch(`https://malex-backend.onrender.com/api/products/${id}`);
  ...
  return (
    <div className="bg-white min-h-screen">
      <HeaderTwo />
      <div className="flex flex-col md:flex-row items-center md:items-start p-3 max-w-4xl mx-auto mt-16 md:mt-20 gap-4 sm:gap-6">
        ...
        <div className="flex-1 flex flex-col space-y-3 sm:space-y-3 w-full max-w-sm sm:max-w-md">
          ...
          <div className="p-3 sm:p-4 bg-white shadow-md border border-gray-200 rounded-md flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-3">
            ...
            <button className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-3 border border-red-500 text-red-500 font-semibold rounded-md w-full transition hover:bg-red-500 hover:text-white">
          ...
          <div className="p-3 sm:p-4 bg-white shadow-md border border-gray-200 rounded-md">
            <button
              className="flex items-center justify-center gap-2 w-full px-3 py-2 sm:px-4 sm:py-3 border border-[#447cfe] text-[#447cfe] font-semibold rounded-md transition hover:bg-[#447cfe] hover:text-white"
              onClick={() => window.location.href = `tel:${product.sellerPhone || "+254702115277"}`}
            >
          ...
          {/* Guidelines Card */}
          <div className="p-4 sm:p-5 bg-gray-100 shadow-md rounded-md text-gray-700">
          ...
          <div className="p-3 sm:p-4 bg-white shadow-md border border-gray-200 rounded-md">
            <button
              onClick={() => router.back()}
              className="w-full px-3 py-2 sm:px-4 sm:py-3 border border-[#447cfe] text-[#447cfe] font-semibold rounded-md transition hover:bg-[#447cfe] hover:text-white"
            >
              Go Back
            </button>
          </div>
