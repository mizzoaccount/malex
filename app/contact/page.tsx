...
export default function ContactPage() {
    return (
      ...
      <section className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        {/* Location Section *
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 bg-white shadow-lg rounded-lg p-8 mt-12">
          {/* Left - Map *
          <div className="w-full h-[500px]">
            <iframe
              className="w-full h-full rounded-lg"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835434509364!2d144.9559283153178!3d-37.817209979751554!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642af0f11fd81%3A0xf4c9c9e9f8f8e41c!2sMelbourne%20Central!5e0!3m2!1sen!2sau!4v1638353840019!5m2!1sen!2sau"
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-gray-600 mb-2">123 Business Street, Suite 100</p>
            <p className="text-gray-600 mb-2">Melbourne, VIC 3000</p>
